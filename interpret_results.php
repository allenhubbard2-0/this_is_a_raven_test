...
?>
<form class="go-bottom" id='submitform' onsubmit="return valthisform(this);" action='interpret_results_response.php' method='post' target='formresponse'>
...
echo '<form method="post" action="interpret_results_response.php">';
...
<div class='container'>
<center>
<form action = 'interpret_results_response.php' target = 'formresponse'>
