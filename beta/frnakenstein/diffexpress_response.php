...
$commands .= "mv $subdirectories/bash_scripts/r_$mytimeid.R $subdirectories/old_bash_scripts &&\n";

# Create bash file output directory
$bashfile = "$subdirectories/bash_scripts/run_$mytimeid.diffexp.sh";

# Create results path
$resultspath = "http://raven.anr.udel.edu/results.php?analysis=analysis_$analysisname";
