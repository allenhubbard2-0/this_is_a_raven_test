...
<h4>Control Condition:</h4> <input type="text" id="controlcondition" name="controlcondition"><br>
...
<h4>Experimental Condition:</h4> <input type="text" id="expcondition" name="expcondition"><br>
...
<br>
<iframe id='frame' name='formresponse' src='placeholder_response.html' style="border: outset; background-color:#d0eace" width='500px' height='<?php echo ($outputwindowcount*12+800)."px"; ?>' frameborder='0'>
