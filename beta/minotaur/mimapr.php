...
<form id='submitform' onsubmit="return valthisform(this);" action='/mimapr_response.php' method='post' target='formresponse'>
...
<?php
$minFiles = "$subdirectories/mirFiles";
$fqfiles = scandir("$minFiles/fastq_to_be_crunched");
...
if(count($fqfiles)<3){ #because of . and .. directories existing
	echo "<b>Note:</b> No fastq files available! (email wtreible@udel.edu)<br>";
} else {
...
if(count($fafiles)<3){ #because of . and .. directories existing
	echo "<b>Note:</b> No fasta mirBase available! (email wtreible@udel.edu)<br>";
} else {
...
$minoFiles = "$subdirectories/mirFiles";
$mirFiles = scandir("$minoFiles/mirBase");   
...
if(count($mirFiles)<3){ #because of . and .. directories existing
	echo "<b>Note:</b> No mirBase files available! (email wtreible@udel.edu)<br>";
} else {
...
-->
<div class='container'>
<button class="crunch" type="submit">Minotaur, Crunch!</button>
</form>
<br><br>
