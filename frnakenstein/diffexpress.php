...
<br>
<iframe id='frame' name='formresponse' src='placeholder_response.html' style="border: none; background-color:#d0eace" width='500px' height='<?php echo ($outputwindowcount*12+900)."px"; ?>' frameborder='0'>
